...
async function seed() {
  try {
    ...
    const initialData = {
      ...
      whoWeAreDescription: "Leveraging advanced technologies to support process industry needs.",
      whoWeAreCards: [
        {
      ...
      useCasesSection: {
        ...
        cards: [
          ...
          { title: 'Improving the Performance of Induced Gas Flotation Unit', image: '/hubfs/Digital Twin.jpg', customGradient: 'linear-gradient(135deg, #0d324d 0%, #00d2ff 100%)', href: '#' },
    ...
    // Delete old and create fresh to ensure clean state
