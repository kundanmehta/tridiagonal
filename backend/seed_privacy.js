  ...
  contentSections: [
    {
      ...
      content: `
        ...
        <p style="color: var(--color-teal); font-weight: bold; margin-bottom: 40px;">
    ...
    },
    {
      title: "Summary",
      content: `
        <p style="margin-bottom: 20px;">This summary section sets out the summary for this Privacy Policy. Further information about this privacy policy is provided within this privacy policy.</p>
        <ul style="list-style-type: disc; padding-left: 20px; display: flex; flex-direction: column; gap: 12px; margin-bottom: 30px;">
    ...
    },
    {
      ...
      content: `
        ...
        <p style="margin-bottom: 20px;">
          You can contact the data controller by emailing <a href="mailto:marketing@tridiagonal.com" style="color: var(--color-teal); text-decoration: none;">marketing@tridiagonal.com</a> or alternatively, write to:
        </p>
        <div style="background: #242424; padding: 25px 30px; border-radius: 12px; border-left: 4px solid var(--color-teal); margin-bottom: 20px;">
          <p style="font-weight: bold; color: #fff; margin: 0 0 5px 0;">Tridiagonal Solutions</p>
    ...
    {
      title: "What and how we use the personal data we collect about you",
      content: `
        <p style="margin-bottom: 20px;">This section sets out the personal data we collect, when you:</p>

        <h3 style="font-size: 22px; color: #fff; margin-top: 30px; margin-bottom: 15px;">Visit our website</h3>
        <p style="margin-bottom: 15px;">We collect and use information from website visitors in accordance with this section and the section entitled 'Disclosure and additional uses of your personal data'.</p>

        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Web Server Log Information</h4>
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Use of website server log information for IT security purposes</h4>
        <p style="margin-bottom: 15px;">
        ...
        <p style="margin-bottom: 15px; font-size: 14px; color: rgba(255,255,255,0.6);">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Cookies</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h3 style="font-size: 22px; color: #fff; margin-top: 35px; margin-bottom: 15px;">Interact with our website</h3>
        <p style="margin-bottom: 15px;">We collect and use information from individuals who interact with particular features of our website.</p>

        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Registering on our website</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Mailing List</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Careers</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Contact Us</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Technical Support</h4>
        <p style="margin-bottom: 15px;">
        ...
        <h4 style="font-size: 18px; color: #fff; margin-top: 25px; margin-bottom: 12px;">Placing an order on our website</h4>
        <p style="margin-bottom: 15px;">
    ...
    {
      title: "Personal data about you from third-parties",
      content: `
        <p style="margin-bottom: 15px;">
    ...
    {
      title: "Disclosure and additional uses of your personal data",
      content: `
        <p style="margin-bottom: 20px;">This sets out the circumstances in which we will disclose information about you to third-parties and any additional purposes for which we use your information.</p>

        <h3 style="font-size: 22px; color: #fff; margin-top: 30px; margin-bottom: 15px;">Sharing your personal data to service providers</h3>
        <p style="margin-bottom: 15px;">
        ...
        <h3 style="font-size: 22px; color: #fff; margin-top: 30px; margin-bottom: 15px;">Sharing your personal data for legal reasons</h3>
        <p style="margin-bottom: 15px;">
        ...
        <h3 style="font-size: 22px; color: #fff; margin-top: 30px; margin-bottom: 15px;">Sharing your personal data to other third-parties</h3>
        <p style="margin-bottom: 15px;">
    ...
    },
    {
      ...
      content: `
        <ul style="list-style-type: disc; padding-left: 20px; display: flex; flex-direction: column; gap: 12px; margin-bottom: 20px;">
    ...
    },
    {
      ...
      content: `
        <p style="margin-bottom: 15px;">We take appropriate technical and organisational measures to secure your information, including:</p>
        <ul style="list-style-type: disc; padding-left: 20px; display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
        ...
        <p style="font-style: italic; color: rgba(255,255,255,0.5); margin-bottom: 15px;">
    ...
    {
      title: "Transfers of your personal data outside of the EEA",
      content: `
        <p style="margin-bottom: 15px;">
    ...
    },
    {
      ...
      content: `
        <p style="margin-bottom: 15px;">Subject to certain limitations, you have the following rights in relation to your personal data, which you can exercise by writing to Tridiagonal Solutions, 12703 Spectrum Drive, San Antonio, TX 78249, or emailing <a href="mailto:marketing@tridiagonal.com" style="color: var(--color-teal); text-decoration: none;">marketing@tridiagonal.com</a>:</p>
        <ul style="list-style-type: disc; padding-left: 20px; display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
        ...
        <h3 style="font-size: 22px; color: #fff; margin-top: 35px; margin-bottom: 15px;">Your right to object to the processing of your personal data</h3>
        <p style="margin-bottom: 15px;">You have the following rights, which you may exercise by writing to Tridiagonal Solutions, 12703 Spectrum Drive, San Antonio, TX 78249 or emailing <a href="mailto:marketing@tridiagonal.com" style="color: var(--color-teal); text-decoration: none;">marketing@tridiagonal.com</a>:</p>
        <ul style="list-style-type: disc; padding-left: 20px; display: flex; flex-direction: column; gap: 10px; margin-bottom: 20px;">
        ...
        <p style="margin-bottom: 15px;">
          You may also exercise your rights by clicking the unsubscribe link contained at the bottom of any marketing email we send to you, or by sending an email to <a href="mailto:marketing@tridiagonal.com" style="color: var(--color-teal); text-decoration: none;">marketing@tridiagonal.com</a> asking that we stop sending you marketing communications and including the words 'OPT OUT' within the Subject.
        </p>
      `
    },
    {
    ...
    },
    {
      ...
      content: `
        <h3 style="font-size: 22px; color: #fff; margin-top: 25px; margin-bottom: 15px;">Children's privacy</h3>
        <p style="margin-bottom: 15px;">
        ...
        <h3 style="font-size: 22px; color: #fff; margin-top: 25px; margin-bottom: 15px;">No rights of third-parties</h3>
...
const seedDB = async () => {
  try {
    ...
    console.log('Cleared existing Privacy Policy data');

    const newPrivacyPolicy = await PrivacyPolicy.create(defaultPrivacyPolicy);
    console.log('Privacy Policy data seeded successfully!');

    process.exit(0);
  } catch (error) {
    require('fs').writeFileSync('seed_error.json', JSON.stringify({ message: error.message, stack: error.stack }, null, 2));
    console.error('Error seeding data. Check seed_error.json for details.');
    process.exit(1);
  }
};
