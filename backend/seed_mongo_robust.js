...
const seed = async () => {
  try {
    ...
    console.log('Removing any existing forms to start fresh...');
    await DynamicForm.deleteMany({}); // Wipe forms
    ...
    console.log('Creating Contact Us Form...');
    ...
    await form.save();
    console.log('Contact Us form successfully seeded with desired fields and consent text!');
