...
export async function generateMetadata() {
  ...
  return constructMetadata(data?.seo, {
    ...
    description: 'Tridiagonal Solutions is a leading CFD, FEA, and DEM consulting company offering advanced modeling, simulation, and one of the largest technology validation & scale-up testing facilities.',
    keywords: 'CFD, FEA, DEM, computational fluid dynamics, finite element analysis, process consulting, technology validation, scale-up centre'
  });
}
